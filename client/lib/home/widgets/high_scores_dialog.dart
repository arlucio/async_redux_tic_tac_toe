...
Container highScoresList(BuildContext context, QuerySnapshot queryResponse) {
  var querySize = queryResponse.documents.length;
  return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          var playerName = queryResponse.documents[index].data['playerName'];
          var playerScore = queryResponse.documents[index].data['score'];
          return ListTile(
            title: Container(
                height: 40.0,
                width: 350.0,
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    SizedBox(width: 30.0, child: Text('  ${index + 1}', style: TextStyle(fontSize: 14.0))),
                    SizedBox(width: 100.0, child: Text('$playerName', style: TextStyle(fontSize: 14.0))),
                    SizedBox(width: 50.0, child: Text('$playerScore', style: TextStyle(fontSize: 14.0))),
                  ],
                )),
          );
        },
