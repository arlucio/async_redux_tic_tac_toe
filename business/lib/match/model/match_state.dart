...
abstract class MatchState implements Built<MatchState, MatchStateBuilder> {
  ...
  factory MatchState.initialState() => MatchState((b) => b
    ...
    ..visitingPlayer = Player.initialState(null).toBuilder()
    ..hashState =
        BuiltList<String>(['none', 'none', 'none', 'none', 'none', 'none', 'none', 'none', 'none'])
            .toBuilder());
